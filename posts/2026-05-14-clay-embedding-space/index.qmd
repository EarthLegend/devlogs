...
The build story (mountain walks, MCP-assisted spec arguments, Claude Code dispatch and dogfooded edges) is over on [the main blog]({https://lgnd.ai/resources/code-assistant}). This post is about what playing the game actually teaches.
